...
rows = run_query("SELECT billing_city, billing_state, billing_latitude, billing_longitude, active_acv from wevideo_analytics.salesforce.active_acv where billing_latitude is not null and billing_longitude is not null and date = last_day(current_date) ;")
